...
Mallorca Padel Camp 2026 LTP Edition (MPC) — a single-page marketing website for a padel tournament/camp event in Mallorca (Aug 18–23, 2026). Built with Next.js 14 App Router, Tailwind CSS, and Framer Motion.
