const en = {
  // Hero
  hero: {
    badge: "🏸 August 18–23, 2026 · Mallorca",
    subtitle: "6 days of padel, sun and Mediterranean. Coaching sessions, sunset boat trip, Corcuera Cup and accommodation at Tomir Portals Suites.",
    ctaRegister: "Register",
    ctaDownload: "Download Breakdown",
    stats: [
      { number: "6", label: "Days", icon: "📅" },
      { number: "5", label: "Sessions", icon: "🏸" },
  ...
  tournament: {
    ...
    title: "What is the",
    titleHighlight: "MPC?",
    description: "The Mallorca Padel Camp LTP Edition is a 6-day experience combining top-level padel, accommodation at Tomir Portals Suites and the best of the Mediterranean. 5 coaching sessions, tournament and boat trip included.",
    categories: [
      {
      ...
      },
      {
        ...
        format: "Fri 21 · 5pm–9pm",
        description: "Official Corcuera Cup competition with all camp participants. The most anticipated moment of the week.",
      },
      {
        title: "Boat Trip",
        icon: "⛵",
        teams: "Included",
        format: "Thu 20 · 7pm–10pm",
        description: "Sunset boat trip through the crystal-clear waters of Mallorca. Padel, sun and Mediterranean — the perfect combination.",
      },
    ],
    schedule: [
      { day: "Tue 18 Aug", event: "Arrival at Palma de Mallorca (PMI) · Airport transfer · Check-in at Tomir Portals Suites · Welcome pack", icon: "✈️" },
      { day: "Wed 19 Aug", event: "Breakfast · Morning session 10am–12pm · Afternoon session 4pm–6pm", icon: "🏸" },
      { day: "Thu 20 Aug", event: "Breakfast · Morning session 10am–12pm · Afternoon session 4pm–6pm · Sunset boat trip 7pm–10pm", icon: "⛵" },
      { day: "Fri 21 Aug", event: "Breakfast · Final session 11am–1pm · Corcuera Cup 5pm–9pm", icon: "🏆" },
      { day: "Sat 22 Aug", event: "Breakfast · Group excursion and leisure day exploring the best of Mallorca", icon: "🗺️" },
      { day: "Sun 23 Aug", event: "Breakfast · Check-out · Airport transfer · Flight back", icon: "🛫" },
    ],
  ...
  location: {
    ...
    info: [
      ...
      { icon: "📅", label: "Dates", value: "August 18–23, 2026 (5 nights)" },
      ...
      { icon: "🏸", label: "Courts", value: "Professional padel courts · 5 sessions + 1 tournament" },
    ],
    button: "View Hotel",
  },
  ...
  results: {
    ...
    dateNote: "August 18–23, 2026 · Tomir Portals Suites, Mallorca",
  ...
  prizes: {
    ...
    items: [
      {
        ...
        description: "5 padel coaching sessions with expert coaches. Morning and evening sessions to improve your game.",
      },
      {
        icon: "🏆",
        title: "Corcuera Cup",
      ...
      },
      {
        ...
        description: "5 nights at one of Mallorca's most exclusive hotels. Portals Nous, minutes from the sea.",
      },
      {
        icon: "✈️",
    ...
    pricing: {
      ...
      full: {
        ...
        price: "2,300",
        currency: "€",
        description: "All inclusive · Accommodation at Tomir Portals Suites",
      },
  ...
  download: {
    ...
    contents: [
      "Complete day-by-day itinerary (August 18–23)",
      "What's included and what's not",
      "Tomir Portals Suites hotel info",
      "5 padel sessions + tournament schedule",
  ...
  registration: {
    ...
    subtitle: "Secure your spot at the Mallorca Padel Camp LTP Edition. August 18–23, 2026 · Tomir Portals Suites. Limited spots.",
    form: {
      fullName: "Full Name *",
  ...
  // Footer
  footer: {
    description: "Padel, sun and Mediterranean. 6 days at Tomir Portals Suites, Mallorca. August 18–23, 2026.",
